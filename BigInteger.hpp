 ...
 * Each put-here operation uses the DTRT_ALIASED_UNS macro (Do The Right Thing on
 ...
 */
#define DTRT_ALIASED_UNS(cond, op) \
	if (cond) { \
		BigUnsigned tmpThis; \
		tmpThis.op; \
		*this = tmpThis; \
...
void BigUnsigned::add(const BigUnsigned &a, const BigUnsigned &b) {
	DTRT_ALIASED_UNS(this == &a || this == &b, add(a, b));
...
void BigUnsigned::subtract(const BigUnsigned &a, const BigUnsigned &b) {
	DTRT_ALIASED_UNS(this == &a || this == &b, subtract(a, b));
	if (b.len == 0) {
		// If b is zero, copy a.
		operator =(a);
		return;
...
void BigUnsigned::multiply(const BigUnsigned &a, const BigUnsigned &b) {
	DTRT_ALIASED_UNS(this == &a || this == &b, multiply(a, b));
...
void BigUnsigned::bitAnd(const BigUnsigned &a, const BigUnsigned &b) {
	DTRT_ALIASED_UNS(this == &a || this == &b, bitAnd(a, b));
...
void BigUnsigned::bitOr(const BigUnsigned &a, const BigUnsigned &b) {
	DTRT_ALIASED_UNS(this == &a || this == &b, bitOr(a, b));
	Index i;
	const BigUnsigned *a2, *b2;
	if (a.len >= b.len) {
		a2 = &a;
...
void BigUnsigned::bitXor(const BigUnsigned &a, const BigUnsigned &b) {
	DTRT_ALIASED_UNS(this == &a || this == &b, bitXor(a, b));
	Index i;
	const BigUnsigned *a2, *b2;
	if (a.len >= b.len) {
		a2 = &a;
...
void BigUnsigned::bitShiftLeft(const BigUnsigned &a, int b) {
	DTRT_ALIASED_UNS(this == &a, bitShiftLeft(a, b));
	if (b < 0) {
		if (b << 1 == 0)
...
void BigUnsigned::bitShiftRight(const BigUnsigned &a, int b) {
	DTRT_ALIASED_UNS(this == &a, bitShiftRight(a, b));
	if (b < 0) {
		if (b << 1 == 0)
...
#define DTRT_ALIASED_INT(cond, op) \
	if (cond) { \
		BigInteger tmpThis; \
		tmpThis.op; \
		*this = tmpThis; \
...
void BigInteger::add(const BigInteger &a, const BigInteger &b) {
	DTRT_ALIASED_INT(this == &a || this == &b, add(a, b));
	// If one argument is zero, copy the other.
	if (a.sign == zero)
		operator =(b);
	else if (b.sign == zero)
...
void BigInteger::subtract(const BigInteger &a, const BigInteger &b) {
	...
	DTRT_ALIASED_INT(this == &a || this == &b, subtract(a, b));
...
void BigInteger::multiply(const BigInteger &a, const BigInteger &b) {
	DTRT_ALIASED_INT(this == &a || this == &b, multiply(a, b));
...
void BigInteger::negate(const BigInteger &a) {
	DTRT_ALIASED_INT(this == &a, negate(a));
	// Copy a's magnitude
	mag = a.mag;
